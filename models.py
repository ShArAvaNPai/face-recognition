...
class Notification(db.Model):
    ...
    title = db.Column(db.String(120), nullable=True)          # short heading (parent alerts etc.)
    message = db.Column(db.String(512), nullable=False)
    category = db.Column(db.String(30), nullable=True)        # 'attendance','absence','fees','marks','general'
